/* =========================================================================
   ...
   file only supplies the content config. The engine marks "text" answers
   leniently (typos/synonyms via edit-distance) with a Cloudflare Workers AI
   fallback judge when the AI binding is present.
   ========================================================================= */
